...
const addToGroup = async (message: Message) => {
    try {
        ...
        if (failedToAdd.length > 0) {
            ...
            message.reply("Nomor berikut tidak terdaftar di WhatsApp: " + failedToAdd.toString().replace(/,/g, " "));
        }
        ...
        if (alreadyInGroup.length > 0) {
            ...
            message.reply("Nomor berikut sudah ada di group: " + failedToAdd.toString().replace(/,/g, " "));
        }
